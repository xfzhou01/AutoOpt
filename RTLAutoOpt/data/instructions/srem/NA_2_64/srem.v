...
(* CORE_GENERATION_INFO="srem_srem,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.249786,HLS_SYN_LAT=58,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=730,HLS_SYN_LUT=661,HLS_VERSION=2022_2}" *)
...
wire   [54:0] grp_fu_45_p2;
wire    ap_CS_fsm_state59;
reg    grp_fu_45_ap_start;
wire    grp_fu_45_ap_done;
reg   [58:0] ap_NS_fsm;
...
srem_srem_55ns_55ns_55_59_seq_1 #(
    .ID( 1 ),
    .NUM_STAGE( 59 ),
    .din0_WIDTH( 55 ),
    .din1_WIDTH( 55 ),
    .dout_WIDTH( 55 ))
srem_55ns_55ns_55_59_seq_1_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .start(grp_fu_45_ap_start),
    .done(grp_fu_45_ap_done),
    .din0(a),
    .din1(b),
    .ce(1'b1),
    .dout(grp_fu_45_p2)
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        grp_fu_45_ap_start = 1'b1;
    end else begin
        grp_fu_45_ap_start = 1'b0;
    end
end
